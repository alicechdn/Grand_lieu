...
info_especes$SITE <- gsub("[����]", "e", info_especes$SITE, ignore.case = TRUE)#Mettre entre crochets tous les caracteres speciaux
info_especes$SITE <- gsub("[��]", "a", info_especes$SITE, ignore.case = TRUE)
